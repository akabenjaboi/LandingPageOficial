...
export default function Home() {
  ...
  useEffect(() => {
    // Animación escalonada al montar
  ...
  return (
    <main className="min-h-screen bg-[#FAF9F6] flex flex-col items-center pt-28 md:pt-36 px-4">
      {/* Hero Section */}
      <section className="w-full max-w-6xl grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-0 items-center">
        {/* Text */}
        <div
