        ...
        {profile?.role === 'leader' && (
          <section className="bg-[#FAF9F6] border border-[#DAD5E4] rounded-2xl shadow-teamzen p-6">
            <div className="flex items-center justify-between mb-4">
              <h2 className="text-lg sm:text-xl font-semibold text-[#2E2E3A]">Lanzar MBI a un equipo</h2>
            </div>
            ...
            <div className="mb-4 bg-[#55C2A2]/10 border border-[#55C2A2]/30 rounded-xl p-3">
              <div className="flex items-start gap-2">
                ...
                <div>
                  <p className="text-xs font-medium text-[#2E2E3A] mb-1">Gestión de ciclos</p>
                  <p className="text-xs text-[#5B5B6B]">
                    Los ciclos MBI duran <strong className="text-[#2E2E3A]">7 días calendario</strong> desde su inicio y se cierran automáticamente.
